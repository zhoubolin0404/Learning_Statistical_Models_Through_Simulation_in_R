...
::: yellowbox
在分类变量-连续变量交互作用部分关于的总体和样本的提醒在这里同样适用。除非模拟数据，你几乎**永远不会**知道你正在研究的任何总体的真实均值。下面，我们讨论的是你实际知道总体均值并且可以在没有任何统计测试的情况下得出结论的假设情况。你观察到的任何真实样本均值都会包含抽样和测量误差，你所做的任何推断都将取决于统计检验的结果，而不是观察到的均值。
:::

#### 情景A {-}

<div class="figure">
<img src="04-交互作用_files/figure-html/scenario-a-plot-1.png" alt="*情景A, 单元平均值图*" width="50%" />
