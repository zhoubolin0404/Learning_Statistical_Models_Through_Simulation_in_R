...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -1.96598 -0.43813 -0.04605  0.70462  1.45491 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.4658     0.4738  -0.983    0.354
## group_d       0.6464     0.6701   0.965    0.363
## 
## Residual standard error: 1.059 on 8 degrees of freedom
## Multiple R-squared:  0.1042,	Adjusted R-squared:  -0.007778 
## F-statistic: 0.9305 on 1 and 8 DF,  p-value: 0.363
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.1806     0.4738   0.381    0.713
## group_d      -0.6464     0.6701  -0.965    0.363
## 
## Residual standard error: 1.059 on 8 degrees of freedom
## Multiple R-squared:  0.1042,	Adjusted R-squared:  -0.007778 
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.4658     0.4738  -0.983    0.354
## groupB        0.6464     0.6701   0.965    0.363
## 
## Residual standard error: 1.059 on 8 degrees of freedom
## Multiple R-squared:  0.1042,	Adjusted R-squared:  -0.007778 
## F-statistic: 0.9305 on 1 and 8 DF,  p-value: 0.363
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -7.4478 -0.5662  0.1083  1.4774  3.3684 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   103.201      1.183  87.248   <2e-16 ***
## seasonspring    1.535      1.673   0.918    0.372    
## seasonsummer   -1.526      1.673  -0.912    0.375    
## seasonwinter    1.775      1.673   1.061    0.304    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.645 on 16 degrees of freedom
## Multiple R-squared:  0.2392,	Adjusted R-squared:  0.09658 
## F-statistic: 1.677 on 3 and 16 DF,  p-value: 0.2119
```
...
## season       3   35.2  11.732   1.677  0.212
## Residuals   16  111.9   6.996
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)     104.9763     1.1828  88.749   <2e-16 ***
## spring_v_winter  -0.2397     1.6728  -0.143    0.888    
## summer_v_winter  -3.3007     1.6728  -1.973    0.066 .  
## fall_v_winter    -1.7750     1.6728  -1.061    0.304    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.645 on 16 degrees of freedom
