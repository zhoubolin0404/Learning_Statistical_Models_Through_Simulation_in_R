...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -1.38291 -0.60692 -0.08164  0.54557  1.50472 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.3304     0.4283   0.771    0.463
## group_d       0.3907     0.6057   0.645    0.537
## 
## Residual standard error: 0.9576 on 8 degrees of freedom
## Multiple R-squared:  0.04945,	Adjusted R-squared:  -0.06936 
## F-statistic: 0.4162 on 1 and 8 DF,  p-value: 0.5369
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.7211     0.4283   1.684    0.131
## group_d      -0.3907     0.6057  -0.645    0.537
## 
## Residual standard error: 0.9576 on 8 degrees of freedom
## Multiple R-squared:  0.04945,	Adjusted R-squared:  -0.06936 
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.3304     0.4283   0.771    0.463
## groupB        0.3907     0.6057   0.645    0.537
## 
## Residual standard error: 0.9576 on 8 degrees of freedom
## Multiple R-squared:  0.04945,	Adjusted R-squared:  -0.06936 
## F-statistic: 0.4162 on 1 and 8 DF,  p-value: 0.5369
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.6483 -2.1986  0.6238  1.7656  4.0495 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  104.7049     1.3183  79.426   <2e-16 ***
## seasonspring  -0.6861     1.8643  -0.368   0.7177    
## seasonsummer  -3.2946     1.8643  -1.767   0.0963 .  
## seasonwinter  -0.1718     1.8643  -0.092   0.9277    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.948 on 16 degrees of freedom
## Multiple R-squared:  0.2021,	Adjusted R-squared:  0.05252 
## F-statistic: 1.351 on 3 and 16 DF,  p-value: 0.2932
```
...
## season       3  35.22  11.740   1.351  0.293
## Residuals   16 139.03   8.689
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)     104.5331     1.3183  79.295   <2e-16 ***
## spring_v_winter  -0.5143     1.8643  -0.276    0.786    
## summer_v_winter  -3.1228     1.8643  -1.675    0.113    
## fall_v_winter     0.1718     1.8643   0.092    0.928    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.948 on 16 degrees of freedom
