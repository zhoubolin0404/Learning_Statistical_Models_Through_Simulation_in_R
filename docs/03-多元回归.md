...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -1.5992 -0.5899 -0.1404  0.4682  1.6825 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  0.09169    0.50799   0.180    0.861
## group_d     -0.34919    0.71841  -0.486    0.640
## 
## Residual standard error: 1.136 on 8 degrees of freedom
## Multiple R-squared:  0.02868,	Adjusted R-squared:  -0.09273 
## F-statistic: 0.2363 on 1 and 8 DF,  p-value: 0.64
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.2575     0.5080  -0.507    0.626
## group_d       0.3492     0.7184   0.486    0.640
## 
## Residual standard error: 1.136 on 8 degrees of freedom
## Multiple R-squared:  0.02868,	Adjusted R-squared:  -0.09273 
## F-statistic: 0.2363 on 1 and 8 DF,  p-value: 0.64
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  0.09169    0.50799   0.180    0.861
## groupB      -0.34919    0.71841  -0.486    0.640
## 
## Residual standard error: 1.136 on 8 degrees of freedom
## Multiple R-squared:  0.02868,	Adjusted R-squared:  -0.09273 
## F-statistic: 0.2363 on 1 and 8 DF,  p-value: 0.64
...
## 10 spring         107.                1               0             0
## 11 summer         101.                0               1             0
## 12 summer          99.6               0               1             0
## 13 summer         102.                0               1             0
## 14 summer          98.1               0               1             0
## 15 summer         101.                0               1             0
## 16 fall           111.                0               0             1
## 17 fall            95.2               0               0             1
## 18 fall           101.                0               0             1
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -7.7397 -2.1633 -0.2026  1.6374  7.8774 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   102.935      1.707  60.308   <2e-16 ***
## seasonspring    1.538      2.414   0.637    0.533    
## seasonsummer   -2.678      2.414  -1.110    0.284    
## seasonwinter    2.575      2.414   1.067    0.302    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.817 on 16 degrees of freedom
## Multiple R-squared:  0.2514,	Adjusted R-squared:  0.111 
## F-statistic: 1.791 on 3 and 16 DF,  p-value: 0.1894
```
...
## season       3  78.26   26.09   1.791  0.189
## Residuals   16 233.06   14.57
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)      105.510      1.707  61.816   <2e-16 ***
## spring_v_winter   -1.037      2.414  -0.430   0.6731    
## summer_v_winter   -5.253      2.414  -2.176   0.0449 *  
## fall_v_winter     -2.575      2.414  -1.067   0.3019    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.817 on 16 degrees of freedom
