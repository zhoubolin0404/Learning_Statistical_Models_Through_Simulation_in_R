...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -1.45894 -0.92797 -0.04096  0.60197  1.70407 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.4739     0.5333  -0.889    0.400
## group_d       0.7539     0.7542   1.000    0.347
## 
## Residual standard error: 1.192 on 8 degrees of freedom
## Multiple R-squared:  0.111,	Adjusted R-squared:  -8.15e-05 
## F-statistic: 0.9993 on 1 and 8 DF,  p-value: 0.3468
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.2800     0.5333   0.525    0.614
## group_d      -0.7539     0.7542  -1.000    0.347
## 
## Residual standard error: 1.192 on 8 degrees of freedom
## Multiple R-squared:  0.111,	Adjusted R-squared:  -8.15e-05 
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.4739     0.5333  -0.889    0.400
## groupB        0.7539     0.7542   1.000    0.347
## 
## Residual standard error: 1.192 on 8 degrees of freedom
## Multiple R-squared:  0.111,	Adjusted R-squared:  -8.15e-05 
## F-statistic: 0.9993 on 1 and 8 DF,  p-value: 0.3468
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.5457 -2.3306 -0.0187  1.6354  7.2122 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  103.2119     1.4457  71.393   <2e-16 ***
## seasonspring   0.1481     2.0445   0.072    0.943    
## seasonsummer  -3.3458     2.0445  -1.636    0.121    
## seasonwinter   0.7541     2.0445   0.369    0.717    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.233 on 16 degrees of freedom
## Multiple R-squared:  0.2353,	Adjusted R-squared:  0.09197 
## F-statistic: 1.641 on 3 and 16 DF,  p-value: 0.2194
```
...
## season       3  51.46   17.15   1.641  0.219
## Residuals   16 167.20   10.45
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)     103.9661     1.4457  71.914   <2e-16 ***
## spring_v_winter  -0.6060     2.0445  -0.296   0.7707    
## summer_v_winter  -4.0999     2.0445  -2.005   0.0621 .  
## fall_v_winter    -0.7541     2.0445  -0.369   0.7171    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.233 on 16 degrees of freedom
