...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -1.6107 -0.5992 -0.2057  0.6641  2.0748 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.1522     0.5081  -0.299    0.772
## group_d      -1.2569     0.7185  -1.749    0.118
## 
## Residual standard error: 1.136 on 8 degrees of freedom
## Multiple R-squared:  0.2767,	Adjusted R-squared:  0.1863 
## F-statistic:  3.06 on 1 and 8 DF,  p-value: 0.1184
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)  
## (Intercept)  -1.4091     0.5081  -2.773   0.0242 *
## group_d       1.2569     0.7185   1.749   0.1184  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 1.136 on 8 degrees of freedom
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.1522     0.5081  -0.299    0.772
## groupB       -1.2569     0.7185  -1.749    0.118
## 
## Residual standard error: 1.136 on 8 degrees of freedom
## Multiple R-squared:  0.2767,	Adjusted R-squared:  0.1863 
## F-statistic:  3.06 on 1 and 8 DF,  p-value: 0.1184
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -3.6038 -0.8166  0.3555  0.8759  2.3840 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  102.1829     0.8018 127.441   <2e-16 ***
## seasonspring   2.0905     1.1339   1.844   0.0838 .  
## seasonsummer   0.1933     1.1339   0.170   0.8668    
## seasonwinter   1.0557     1.1339   0.931   0.3657    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 1.793 on 16 degrees of freedom
## Multiple R-squared:   0.21,	Adjusted R-squared:  0.06186 
## F-statistic: 1.418 on 3 and 16 DF,  p-value: 0.2743
```
...
## season       3  13.67   4.557   1.418  0.274
## Residuals   16  51.43   3.214
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)     103.2387     0.8018 128.758   <2e-16 ***
## spring_v_winter   1.0348     1.1339   0.913    0.375    
## summer_v_winter  -0.8624     1.1339  -0.761    0.458    
## fall_v_winter    -1.0557     1.1339  -0.931    0.366    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 1.793 on 16 degrees of freedom
