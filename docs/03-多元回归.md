...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -1.1026 -0.7405 -0.2484  0.7384  1.2842 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  0.09637    0.40995   0.235    0.820
## group_d      1.01186    0.57975   1.745    0.119
## 
## Residual standard error: 0.9167 on 8 degrees of freedom
## Multiple R-squared:  0.2758,	Adjusted R-squared:  0.1852 
## F-statistic: 3.046 on 1 and 8 DF,  p-value: 0.1191
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)  
## (Intercept)   1.1082     0.4099   2.703   0.0269 *
## group_d      -1.0119     0.5798  -1.745   0.1191  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.9167 on 8 degrees of freedom
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  0.09637    0.40995   0.235    0.820
## groupB       1.01186    0.57975   1.745    0.119
## 
## Residual standard error: 0.9167 on 8 degrees of freedom
## Multiple R-squared:  0.2758,	Adjusted R-squared:  0.1852 
## F-statistic: 3.046 on 1 and 8 DF,  p-value: 0.1191
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.4481 -0.8221  0.0443  1.6033  3.6902 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   101.743      1.127  90.242   <2e-16 ***
## seasonspring    1.238      1.594   0.776   0.4488    
## seasonsummer    0.425      1.594   0.267   0.7932    
## seasonwinter    3.147      1.594   1.974   0.0659 .  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.521 on 16 degrees of freedom
## Multiple R-squared:  0.2229,	Adjusted R-squared:  0.07717 
## F-statistic:  1.53 on 3 and 16 DF,  p-value: 0.2452
```
...
## season       3  29.17   9.722    1.53  0.245
## Residuals   16 101.69   6.356
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)      104.889      1.127  93.033   <2e-16 ***
## spring_v_winter   -1.909      1.594  -1.197   0.2486    
## summer_v_winter   -2.722      1.594  -1.707   0.1071    
## fall_v_winter     -3.147      1.594  -1.974   0.0659 .  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.521 on 16 degrees of freedom
