...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -1.2975 -0.5869  0.1235  0.7984  0.9763 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -0.07545    0.42220  -0.179    0.863
## group_d     -0.41573    0.59707  -0.696    0.506
## 
## Residual standard error: 0.9441 on 8 degrees of freedom
## Multiple R-squared:  0.05714,	Adjusted R-squared:  -0.06072 
## F-statistic: 0.4848 on 1 and 8 DF,  p-value: 0.506
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.4912     0.4222  -1.163    0.278
## group_d       0.4157     0.5971   0.696    0.506
## 
## Residual standard error: 0.9441 on 8 degrees of freedom
## Multiple R-squared:  0.05714,	Adjusted R-squared:  -0.06072 
## F-statistic: 0.4848 on 1 and 8 DF,  p-value: 0.506
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -0.07545    0.42220  -0.179    0.863
## groupB      -0.41573    0.59707  -0.696    0.506
## 
## Residual standard error: 0.9441 on 8 degrees of freedom
## Multiple R-squared:  0.05714,	Adjusted R-squared:  -0.06072 
## F-statistic: 0.4848 on 1 and 8 DF,  p-value: 0.506
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.0333 -0.7693  0.1717  1.3649  4.5669 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   102.624      1.217  84.301   <2e-16 ***
## seasonspring    1.818      1.722   1.056    0.307    
## seasonsummer   -1.231      1.722  -0.715    0.485    
## seasonwinter    2.570      1.722   1.493    0.155    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.722 on 16 degrees of freedom
## Multiple R-squared:  0.2737,	Adjusted R-squared:  0.1375 
## F-statistic: 2.009 on 3 and 16 DF,  p-value: 0.1532
```
...
## season       3  44.67   14.89   2.009  0.153
## Residuals   16 118.56    7.41
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)     105.1944     1.2174  86.412   <2e-16 ***
## spring_v_winter  -0.7524     1.7216  -0.437   0.6679    
## summer_v_winter  -3.8010     1.7216  -2.208   0.0422 *  
## fall_v_winter    -2.5703     1.7216  -1.493   0.1549    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.722 on 16 degrees of freedom
