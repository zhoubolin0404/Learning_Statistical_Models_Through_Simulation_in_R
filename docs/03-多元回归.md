...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -2.59155 -0.83835  0.03037  1.24215  1.70219 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.2178     0.6715   0.324    0.754
## group_d       0.7954     0.9497   0.838    0.427
## 
## Residual standard error: 1.502 on 8 degrees of freedom
## Multiple R-squared:  0.08061,	Adjusted R-squared:  -0.03431 
## F-statistic: 0.7014 on 1 and 8 DF,  p-value: 0.4266
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   1.0131     0.6715   1.509    0.170
## group_d      -0.7954     0.9497  -0.838    0.427
## 
## Residual standard error: 1.502 on 8 degrees of freedom
## Multiple R-squared:  0.08061,	Adjusted R-squared:  -0.03431 
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.2178     0.6715   0.324    0.754
## groupB        0.7954     0.9497   0.838    0.427
## 
## Residual standard error: 1.502 on 8 degrees of freedom
## Multiple R-squared:  0.08061,	Adjusted R-squared:  -0.03431 
## F-statistic: 0.7014 on 1 and 8 DF,  p-value: 0.4266
...
## 10 spring         105.                1               0             0
## 11 summer         100.                0               1             0
## 12 summer          94.7               0               1             0
## 13 summer         105.                0               1             0
## 14 summer          99.4               0               1             0
## 15 summer         102.                0               1             0
## 16 fall            96.2               0               0             1
## 17 fall           105.                0               0             1
## 18 fall           103.                0               0             1
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.5803 -1.9235 -0.4105  1.7489  5.0493 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)    99.921      1.450  68.932   <2e-16 ***
## seasonspring    5.525      2.050   2.695   0.0159 *  
## seasonsummer    0.384      2.050   0.187   0.8538    
## seasonwinter    2.889      2.050   1.409   0.1779    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.241 on 16 degrees of freedom
## Multiple R-squared:  0.3691,	Adjusted R-squared:  0.2508 
## F-statistic:  3.12 on 3 and 16 DF,  p-value: 0.05539
```
...
## season       3  98.35   32.78    3.12 0.0554 .
## Residuals   16 168.10   10.51                 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)      102.810      1.450  70.925   <2e-16 ***
## spring_v_winter    2.637      2.050   1.286    0.217    
## summer_v_winter   -2.505      2.050  -1.222    0.239    
## fall_v_winter     -2.889      2.050  -1.409    0.178    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.241 on 16 degrees of freedom
