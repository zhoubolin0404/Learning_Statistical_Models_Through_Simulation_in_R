...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -0.9808 -0.6877 -0.3372  0.7669  1.5829 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.4006     0.4432  -0.904    0.392
## group_d       0.3323     0.6267   0.530    0.610
## 
## Residual standard error: 0.9909 on 8 degrees of freedom
## Multiple R-squared:  0.03395,	Adjusted R-squared:  -0.08681 
## F-statistic: 0.2811 on 1 and 8 DF,  p-value: 0.6104
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -0.06827    0.44315  -0.154    0.881
## group_d     -0.33230    0.62672  -0.530    0.610
## 
## Residual standard error: 0.9909 on 8 degrees of freedom
## Multiple R-squared:  0.03395,	Adjusted R-squared:  -0.08681 
## F-statistic: 0.2811 on 1 and 8 DF,  p-value: 0.6104
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.4006     0.4432  -0.904    0.392
## groupB        0.3323     0.6267   0.530    0.610
## 
## Residual standard error: 0.9909 on 8 degrees of freedom
## Multiple R-squared:  0.03395,	Adjusted R-squared:  -0.08681 
## F-statistic: 0.2811 on 1 and 8 DF,  p-value: 0.6104
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.1310 -0.8311  0.2098  1.8197  2.8502 
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  102.45824    1.10502  92.720   <2e-16 ***
## seasonspring   2.22990    1.56274   1.427   0.1728    
## seasonsummer   0.07909    1.56274   0.051   0.9603    
## seasonwinter   3.32073    1.56274   2.125   0.0495 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.471 on 16 degrees of freedom
## Multiple R-squared:  0.2926,	Adjusted R-squared:   0.16 
## F-statistic: 2.206 on 3 and 16 DF,  p-value: 0.127
```
...
## season       3  40.41  13.471   2.206  0.127
## Residuals   16  97.69   6.105
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)      105.779      1.105  95.725   <2e-16 ***
## spring_v_winter   -1.091      1.563  -0.698   0.4952    
## summer_v_winter   -3.242      1.563  -2.074   0.0545 .  
## fall_v_winter     -3.321      1.563  -2.125   0.0495 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.471 on 16 degrees of freedom
