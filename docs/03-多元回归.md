...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -1.24964 -0.38232 -0.03138  0.37820  0.98940 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.2083     0.3200  -0.651    0.533
## group_d       0.1829     0.4526   0.404    0.697
## 
## Residual standard error: 0.7156 on 8 degrees of freedom
## Multiple R-squared:  0.02001,	Adjusted R-squared:  -0.1025 
## F-statistic: 0.1634 on 1 and 8 DF,  p-value: 0.6967
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -0.02542    0.32003  -0.079    0.939
## group_d     -0.18292    0.45259  -0.404    0.697
## 
## Residual standard error: 0.7156 on 8 degrees of freedom
## Multiple R-squared:  0.02001,	Adjusted R-squared:  -0.1025 
## F-statistic: 0.1634 on 1 and 8 DF,  p-value: 0.6967
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.2083     0.3200  -0.651    0.533
## groupB        0.1829     0.4526   0.404    0.697
## 
## Residual standard error: 0.7156 on 8 degrees of freedom
## Multiple R-squared:  0.02001,	Adjusted R-squared:  -0.1025 
## F-statistic: 0.1634 on 1 and 8 DF,  p-value: 0.6967
...
##  9 spring          99.7               1               0             0
## 10 spring         104.                1               0             0
## 11 summer          94.0               0               1             0
## 12 summer          98.6               0               1             0
## 13 summer         102.                0               1             0
## 14 summer         100.                0               1             0
## 15 summer         104.                0               1             0
## 16 fall            99.4               0               0             1
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.7995 -1.3942  0.2634  2.5077  4.3494 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   104.355      1.497  69.700   <2e-16 ***
## seasonspring   -2.793      2.117  -1.319   0.2056    
## seasonsummer   -4.549      2.117  -2.148   0.0473 *  
## seasonwinter    1.277      2.117   0.603   0.5547    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.348 on 16 degrees of freedom
## Multiple R-squared:  0.3685,	Adjusted R-squared:  0.2501 
## F-statistic: 3.112 on 3 and 16 DF,  p-value: 0.05578
```
...
## season       3  104.7   34.88   3.112 0.0558 .
## Residuals   16  179.3   11.21                 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)      105.632      1.497  70.554   <2e-16 ***
## spring_v_winter   -4.071      2.117  -1.923   0.0725 .  
## summer_v_winter   -5.826      2.117  -2.752   0.0142 *  
## fall_v_winter     -1.277      2.117  -0.603   0.5547    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.348 on 16 degrees of freedom
