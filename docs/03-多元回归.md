...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -2.03198 -0.64043 -0.05744  0.32393  2.81278 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.1484     0.5931   0.250    0.809
## group_d      -0.4419     0.8387  -0.527    0.613
## 
## Residual standard error: 1.326 on 8 degrees of freedom
## Multiple R-squared:  0.03353,	Adjusted R-squared:  -0.08728 
## F-statistic: 0.2775 on 1 and 8 DF,  p-value: 0.6126
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.2935     0.5931  -0.495    0.634
## group_d       0.4419     0.8387   0.527    0.613
## 
## Residual standard error: 1.326 on 8 degrees of freedom
## Multiple R-squared:  0.03353,	Adjusted R-squared:  -0.08728 
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.1484     0.5931   0.250    0.809
## groupB       -0.4419     0.8387  -0.527    0.613
## 
## Residual standard error: 1.326 on 8 degrees of freedom
## Multiple R-squared:  0.03353,	Adjusted R-squared:  -0.08728 
## F-statistic: 0.2775 on 1 and 8 DF,  p-value: 0.6126
...
## Residuals:
##    Min     1Q Median     3Q    Max 
## -3.825 -2.331 -1.125  2.543  6.274 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  102.2101     1.4289  71.532   <2e-16 ***
## seasonspring   2.7540     2.0207   1.363    0.192    
## seasonsummer  -0.8227     2.0207  -0.407    0.689    
## seasonwinter   3.2165     2.0207   1.592    0.131    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.195 on 16 degrees of freedom
## Multiple R-squared:  0.2684,	Adjusted R-squared:  0.1312 
## F-statistic: 1.956 on 3 and 16 DF,  p-value: 0.1613
```
...
## season       3  59.91   19.97   1.956  0.161
## Residuals   16 163.34   10.21
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)     105.4267     1.4289  73.783   <2e-16 ***
## spring_v_winter  -0.4625     2.0207  -0.229   0.8218    
## summer_v_winter  -4.0393     2.0207  -1.999   0.0629 .  
## fall_v_winter    -3.2165     2.0207  -1.592   0.1310    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.195 on 16 degrees of freedom
