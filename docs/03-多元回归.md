...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -1.14766 -0.13051  0.07458  0.13536  1.16692 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)  
## (Intercept)  -0.4519     0.3016  -1.498   0.1724  
## group_d       1.0751     0.4265   2.521   0.0358 *
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.6743 on 8 degrees of freedom
## Multiple R-squared:  0.4427,	Adjusted R-squared:  0.373 
## F-statistic: 6.354 on 1 and 8 DF,  p-value: 0.03576
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)  
## (Intercept)   0.6232     0.3016   2.067   0.0726 .
## group_d      -1.0751     0.4265  -2.521   0.0358 *
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
...
##             Estimate Std. Error t value Pr(>|t|)  
## (Intercept)  -0.4519     0.3016  -1.498   0.1724  
## groupB        1.0751     0.4265   2.521   0.0358 *
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.6743 on 8 degrees of freedom
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.8665 -0.9646 -0.0417  1.6599  3.2477 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   103.531      1.053  98.338   <2e-16 ***
## seasonspring   -1.836      1.489  -1.233    0.235    
## seasonsummer   -2.012      1.489  -1.351    0.195    
## seasonwinter    1.472      1.489   0.989    0.338    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.354 on 16 degrees of freedom
## Multiple R-squared:  0.3155,	Adjusted R-squared:  0.1871 
## F-statistic: 2.458 on 3 and 16 DF,  p-value: 0.1004
```
...
## season       3  40.87  13.622   2.458    0.1
## Residuals   16  88.67   5.542
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)      105.003      1.053  99.737   <2e-16 ***
## spring_v_winter   -3.308      1.489  -2.222   0.0411 *  
## summer_v_winter   -3.484      1.489  -2.340   0.0326 *  
## fall_v_winter     -1.472      1.489  -0.989   0.3375    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.354 on 16 degrees of freedom
