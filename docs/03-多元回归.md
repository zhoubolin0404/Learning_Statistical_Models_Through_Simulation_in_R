...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -1.1942 -0.5109  0.1175  0.3698  1.5837 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  0.09858    0.39076   0.252    0.807
## group_d     -0.01639    0.55263  -0.030    0.977
## 
## Residual standard error: 0.8738 on 8 degrees of freedom
## Multiple R-squared:  0.0001099,	Adjusted R-squared:  -0.1249 
## F-statistic: 0.0008791 on 1 and 8 DF,  p-value: 0.9771
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  0.08219    0.39076    0.21    0.839
## group_d      0.01639    0.55263    0.03    0.977
## 
## Residual standard error: 0.8738 on 8 degrees of freedom
## Multiple R-squared:  0.0001099,	Adjusted R-squared:  -0.1249 
## F-statistic: 0.0008791 on 1 and 8 DF,  p-value: 0.9771
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  0.09858    0.39076   0.252    0.807
## groupB      -0.01639    0.55263  -0.030    0.977
## 
## Residual standard error: 0.8738 on 8 degrees of freedom
## Multiple R-squared:  0.0001099,	Adjusted R-squared:  -0.1249 
## F-statistic: 0.0008791 on 1 and 8 DF,  p-value: 0.9771
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -2.6765 -1.7151  0.2276  1.3370  2.5897 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  101.3070     0.8019 126.339   <2e-16 ***
## seasonspring   1.2306     1.1340   1.085   0.2939    
## seasonsummer  -1.3409     1.1340  -1.182   0.2543    
## seasonwinter   2.9442     1.1340   2.596   0.0195 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 1.793 on 16 degrees of freedom
## Multiple R-squared:  0.4922,	Adjusted R-squared:  0.397 
## F-statistic:  5.17 on 3 and 16 DF,  p-value: 0.01092
```
...
## season       3  49.87  16.622    5.17 0.0109 *
## Residuals   16  51.44   3.215                 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)     104.2512     0.8019 130.011  < 2e-16 ***
## spring_v_winter  -1.7136     1.1340  -1.511  0.15025    
## summer_v_winter  -4.2851     1.1340  -3.779  0.00164 ** 
## fall_v_winter    -2.9442     1.1340  -2.596  0.01949 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 1.793 on 16 degrees of freedom
