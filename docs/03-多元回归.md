...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -0.9879 -0.4001 -0.2242  0.2376  1.9151 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)  
## (Intercept)  -0.2418     0.4037  -0.599   0.5658  
## group_d       1.0701     0.5710   1.874   0.0978 .
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.9028 on 8 degrees of freedom
## Multiple R-squared:  0.3051,	Adjusted R-squared:  0.2183 
## F-statistic: 3.513 on 1 and 8 DF,  p-value: 0.09777
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)  
## (Intercept)   0.8283     0.4037   2.052   0.0743 .
## group_d      -1.0701     0.5710  -1.874   0.0978 .
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
...
##             Estimate Std. Error t value Pr(>|t|)  
## (Intercept)  -0.2418     0.4037  -0.599   0.5658  
## groupB        1.0701     0.5710   1.874   0.0978 .
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.9028 on 8 degrees of freedom
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.5153 -1.2508  0.4682  1.8014  4.3540 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  104.8682     1.3345  78.580   <2e-16 ***
## seasonspring  -0.7725     1.8873  -0.409    0.688    
## seasonsummer  -2.2033     1.8873  -1.167    0.260    
## seasonwinter  -1.4009     1.8873  -0.742    0.469    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.984 on 16 degrees of freedom
## Multiple R-squared:  0.08434,	Adjusted R-squared:  -0.08734 
## F-statistic: 0.4913 on 3 and 16 DF,  p-value: 0.6933
```
...
## season       3  13.12   4.375   0.491  0.693
## Residuals   16 142.48   8.905
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)     103.4673     1.3345  77.530   <2e-16 ***
## spring_v_winter   0.6284     1.8873   0.333    0.743    
## summer_v_winter  -0.8024     1.8873  -0.425    0.676    
## fall_v_winter     1.4009     1.8873   0.742    0.469    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.984 on 16 degrees of freedom
