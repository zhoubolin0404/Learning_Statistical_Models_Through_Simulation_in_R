...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -1.0710 -0.5470 -0.1172  0.4612  1.9804 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)  
## (Intercept)  -1.0656     0.4293  -2.482    0.038 *
## group_d       1.3098     0.6071   2.158    0.063 .
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.9598 on 8 degrees of freedom
## Multiple R-squared:  0.3679,	Adjusted R-squared:  0.2888 
## F-statistic: 4.655 on 1 and 8 DF,  p-value: 0.06302
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)  
## (Intercept)   0.2443     0.4293   0.569    0.585  
## group_d      -1.3098     0.6071  -2.158    0.063 .
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
...
##             Estimate Std. Error t value Pr(>|t|)  
## (Intercept)  -1.0656     0.4293  -2.482    0.038 *
## groupB        1.3098     0.6071   2.158    0.063 .
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.9598 on 8 degrees of freedom
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.3366 -1.4214 -0.3718  0.5815  5.3826 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   105.076      1.252  83.898   <2e-16 ***
## seasonspring   -2.665      1.771  -1.505    0.152    
## seasonsummer   -1.142      1.771  -0.645    0.528    
## seasonwinter    1.038      1.771   0.586    0.566    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.801 on 16 degrees of freedom
## Multiple R-squared:  0.2317,	Adjusted R-squared:  0.08765 
## F-statistic: 1.608 on 3 and 16 DF,  p-value: 0.2267
```
...
## season       3  37.84  12.615   1.608  0.227
## Residuals   16 125.49   7.843
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)      106.114      1.252  84.727   <2e-16 ***
## spring_v_winter   -3.703      1.771  -2.091   0.0528 .  
## summer_v_winter   -2.181      1.771  -1.231   0.2360    
## fall_v_winter     -1.038      1.771  -0.586   0.5658    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.801 on 16 degrees of freedom
