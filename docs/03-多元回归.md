...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -1.67878 -0.29275  0.07343  0.51133  0.83713 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)  
## (Intercept)   1.0428     0.3504   2.976   0.0177 *
## group_d      -0.7775     0.4955  -1.569   0.1552  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.7834 on 8 degrees of freedom
## Multiple R-squared:  0.2354,	Adjusted R-squared:  0.1398 
## F-statistic: 2.463 on 1 and 8 DF,  p-value: 0.1552
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.2653     0.3504   0.757    0.471
## group_d       0.7775     0.4955   1.569    0.155
## 
## Residual standard error: 0.7834 on 8 degrees of freedom
## Multiple R-squared:  0.2354,	Adjusted R-squared:  0.1398 
## F-statistic: 2.463 on 1 and 8 DF,  p-value: 0.1552
...
##             Estimate Std. Error t value Pr(>|t|)  
## (Intercept)   1.0428     0.3504   2.976   0.0177 *
## groupB       -0.7775     0.4955  -1.569   0.1552  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.7834 on 8 degrees of freedom
...
## 10 spring         102.                1               0             0
## 11 summer         101.                0               1             0
## 12 summer          97.3               0               1             0
## 13 summer         106.                0               1             0
## 14 summer         102.                0               1             0
## 15 summer          99.2               0               1             0
## 16 fall           108.                0               0             1
## 17 fall           104.                0               0             1
## 18 fall           107.                0               0             1
## 19 fall           105.                0               0             1
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.4957 -1.5732 -0.3535  1.2184  4.4359 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  105.9510     1.2074  87.750   <2e-16 ***
## seasonspring  -1.4756     1.7075  -0.864   0.4003    
## seasonsummer  -4.7771     1.7075  -2.798   0.0129 *  
## seasonwinter   0.7997     1.7075   0.468   0.6459    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.7 on 16 degrees of freedom
## Multiple R-squared:  0.4383,	Adjusted R-squared:  0.333 
## F-statistic: 4.162 on 3 and 16 DF,  p-value: 0.02336
```
...
## season       3  91.02  30.340   4.162 0.0234 *
## Residuals   16 116.63   7.289                 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)     106.7507     1.2074  88.412  < 2e-16 ***
## spring_v_winter  -2.2753     1.7075  -1.333  0.20136    
## summer_v_winter  -5.5768     1.7075  -3.266  0.00486 ** 
## fall_v_winter    -0.7997     1.7075  -0.468  0.64586    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.7 on 16 degrees of freedom
