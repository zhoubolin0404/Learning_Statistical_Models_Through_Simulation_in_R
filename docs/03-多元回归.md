...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -0.7533 -0.4767 -0.2277  0.3457  1.1466 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.3992     0.3182   1.254    0.245
## group_d      -0.4982     0.4500  -1.107    0.300
## 
## Residual standard error: 0.7116 on 8 degrees of freedom
## Multiple R-squared:  0.1328,	Adjusted R-squared:  0.02444 
## F-statistic: 1.225 on 1 and 8 DF,  p-value: 0.3005
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -0.09904    0.31823  -0.311    0.764
## group_d      0.49819    0.45004   1.107    0.300
## 
## Residual standard error: 0.7116 on 8 degrees of freedom
## Multiple R-squared:  0.1328,	Adjusted R-squared:  0.02444 
## F-statistic: 1.225 on 1 and 8 DF,  p-value: 0.3005
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.3992     0.3182   1.254    0.245
## groupB       -0.4982     0.4500  -1.107    0.300
## 
## Residual standard error: 0.7116 on 8 degrees of freedom
## Multiple R-squared:  0.1328,	Adjusted R-squared:  0.02444 
## F-statistic: 1.225 on 1 and 8 DF,  p-value: 0.3005
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.9084 -2.1114  0.2161  0.9460  7.6487 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   106.233      1.417  74.975   <2e-16 ***
## seasonspring   -2.116      2.004  -1.056   0.3067    
## seasonsummer   -5.086      2.004  -2.538   0.0219 *  
## seasonwinter   -2.275      2.004  -1.135   0.2731    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.168 on 16 degrees of freedom
## Multiple R-squared:  0.2892,	Adjusted R-squared:  0.1559 
## F-statistic:  2.17 on 3 and 16 DF,  p-value: 0.1315
```
...
## season       3  65.34   21.78    2.17  0.131
## Residuals   16 160.61   10.04
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)     103.9586     1.4169  73.369   <2e-16 ***
## spring_v_winter   0.1587     2.0038   0.079    0.938    
## summer_v_winter  -2.8116     2.0038  -1.403    0.180    
## fall_v_winter     2.2745     2.0038   1.135    0.273    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.168 on 16 degrees of freedom
