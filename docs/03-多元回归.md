...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -1.3350 -1.0090  0.1978  0.5373  1.6725 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -0.16354    0.52558  -0.311    0.764
## group_d      0.08614    0.74328   0.116    0.911
## 
## Residual standard error: 1.175 on 8 degrees of freedom
## Multiple R-squared:  0.001676,	Adjusted R-squared:  -0.1231 
## F-statistic: 0.01343 on 1 and 8 DF,  p-value: 0.9106
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -0.07740    0.52558  -0.147    0.887
## group_d     -0.08614    0.74328  -0.116    0.911
## 
## Residual standard error: 1.175 on 8 degrees of freedom
## Multiple R-squared:  0.001676,	Adjusted R-squared:  -0.1231 
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -0.16354    0.52558  -0.311    0.764
## groupB       0.08614    0.74328   0.116    0.911
## 
## Residual standard error: 1.175 on 8 degrees of freedom
## Multiple R-squared:  0.001676,	Adjusted R-squared:  -0.1231 
## F-statistic: 0.01343 on 1 and 8 DF,  p-value: 0.9106
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.6701 -0.8290 -0.0091  1.6659  7.1016 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  103.3929     1.5455  66.898   <2e-16 ***
## seasonspring   0.4299     2.1857   0.197   0.8465    
## seasonsummer  -0.4368     2.1857  -0.200   0.8441    
## seasonwinter   4.0210     2.1857   1.840   0.0844 .  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.456 on 16 degrees of freedom
## Multiple R-squared:  0.2467,	Adjusted R-squared:  0.1054 
## F-statistic: 1.747 on 3 and 16 DF,  p-value: 0.1979
```
...
## season       3  62.58   20.86   1.747  0.198
## Residuals   16 191.09   11.94
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)      107.414      1.546  69.500   <2e-16 ***
## spring_v_winter   -3.591      2.186  -1.643   0.1199    
## summer_v_winter   -4.458      2.186  -2.040   0.0583 .  
## fall_v_winter     -4.021      2.186  -1.840   0.0844 .  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.456 on 16 degrees of freedom
