...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -1.60982 -0.16245  0.07759  0.32702  1.20882 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.3238     0.4136   0.783    0.456
## group_d      -0.6902     0.5849  -1.180    0.272
## 
## Residual standard error: 0.9248 on 8 degrees of freedom
## Multiple R-squared:  0.1482,	Adjusted R-squared:  0.04176 
## F-statistic: 1.392 on 1 and 8 DF,  p-value: 0.2719
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.3663     0.4136  -0.886    0.402
## group_d       0.6902     0.5849   1.180    0.272
## 
## Residual standard error: 0.9248 on 8 degrees of freedom
## Multiple R-squared:  0.1482,	Adjusted R-squared:  0.04176 
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.3238     0.4136   0.783    0.456
## groupB       -0.6902     0.5849  -1.180    0.272
## 
## Residual standard error: 0.9248 on 8 degrees of freedom
## Multiple R-squared:  0.1482,	Adjusted R-squared:  0.04176 
## F-statistic: 1.392 on 1 and 8 DF,  p-value: 0.2719
...
## 10 spring         101.                1               0             0
## 11 summer         103.                0               1             0
## 12 summer          98.0               0               1             0
## 13 summer         104.                0               1             0
## 14 summer          99.9               0               1             0
## 15 summer         104.                0               1             0
## 16 fall            98.3               0               0             1
## 17 fall            99.9               0               0             1
## 18 fall            99.4               0               0             1
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -3.6356 -1.7266  0.0501  1.7957  3.7035 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  101.2442     1.0680  94.802   <2e-16 ***
## seasonspring   2.9282     1.5103   1.939   0.0704 .  
## seasonsummer   0.3539     1.5103   0.234   0.8177    
## seasonwinter   3.8921     1.5103   2.577   0.0203 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.388 on 16 degrees of freedom
## Multiple R-squared:  0.3757,	Adjusted R-squared:  0.2586 
## F-statistic: 3.209 on 3 and 16 DF,  p-value: 0.05129
```
...
## season       3  54.90  18.301   3.209 0.0513 .
## Residuals   16  91.24   5.703                 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)      105.136      1.068  98.446   <2e-16 ***
## spring_v_winter   -0.964      1.510  -0.638   0.5323    
## summer_v_winter   -3.538      1.510  -2.343   0.0324 *  
## fall_v_winter     -3.892      1.510  -2.577   0.0203 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.388 on 16 degrees of freedom
