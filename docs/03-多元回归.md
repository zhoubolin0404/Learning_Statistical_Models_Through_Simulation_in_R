...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -1.44186 -0.82583  0.07133  0.42012  1.91083 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.2816     0.5316   0.530    0.611
## group_d      -0.2353     0.7518  -0.313    0.762
## 
## Residual standard error: 1.189 on 8 degrees of freedom
## Multiple R-squared:  0.01209,	Adjusted R-squared:  -0.1114 
## F-statistic: 0.09794 on 1 and 8 DF,  p-value: 0.7623
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  0.04628    0.53159   0.087    0.933
## group_d      0.23528    0.75179   0.313    0.762
## 
## Residual standard error: 1.189 on 8 degrees of freedom
## Multiple R-squared:  0.01209,	Adjusted R-squared:  -0.1114 
## F-statistic: 0.09794 on 1 and 8 DF,  p-value: 0.7623
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.2816     0.5316   0.530    0.611
## groupB       -0.2353     0.7518  -0.313    0.762
## 
## Residual standard error: 1.189 on 8 degrees of freedom
## Multiple R-squared:  0.01209,	Adjusted R-squared:  -0.1114 
## F-statistic: 0.09794 on 1 and 8 DF,  p-value: 0.7623
...
## 10 spring         105.                1               0             0
## 11 summer         103.                0               1             0
## 12 summer          95.3               0               1             0
## 13 summer          97.8               0               1             0
## 14 summer         102.                0               1             0
## 15 summer         100.                0               1             0
## 16 fall           103.                0               0             1
## 17 fall            99.5               0               0             1
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.4075 -1.9638  0.1498  2.1149  5.4532 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  103.5348     1.3735  75.380   <2e-16 ***
## seasonspring   0.5383     1.9424   0.277   0.7852    
## seasonsummer  -3.8672     1.9424  -1.991   0.0639 .  
## seasonwinter   1.6755     1.9424   0.863   0.4011    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.071 on 16 degrees of freedom
## Multiple R-squared:  0.3653,	Adjusted R-squared:  0.2462 
## F-statistic: 3.069 on 3 and 16 DF,  p-value: 0.05794
```
...
## season       3  86.84  28.948   3.069 0.0579 .
## Residuals   16 150.92   9.432                 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)      105.210      1.373  76.600   <2e-16 ***
## spring_v_winter   -1.137      1.942  -0.585   0.5664    
## summer_v_winter   -5.543      1.942  -2.853   0.0115 *  
## fall_v_winter     -1.675      1.942  -0.863   0.4011    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.071 on 16 degrees of freedom
