...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -1.44376 -0.81361 -0.03395  0.68303  1.58306 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.1875     0.5230   0.358    0.729
## group_d      -0.4476     0.7396  -0.605    0.562
## 
## Residual standard error: 1.169 on 8 degrees of freedom
## Multiple R-squared:  0.04378,	Adjusted R-squared:  -0.07575 
## F-statistic: 0.3663 on 1 and 8 DF,  p-value: 0.5618
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.2601     0.5230  -0.497    0.632
## group_d       0.4476     0.7396   0.605    0.562
## 
## Residual standard error: 1.169 on 8 degrees of freedom
## Multiple R-squared:  0.04378,	Adjusted R-squared:  -0.07575 
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.1875     0.5230   0.358    0.729
## groupB       -0.4476     0.7396  -0.605    0.562
## 
## Residual standard error: 1.169 on 8 degrees of freedom
## Multiple R-squared:  0.04378,	Adjusted R-squared:  -0.07575 
## F-statistic: 0.3663 on 1 and 8 DF,  p-value: 0.5618
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.1410 -1.4055  0.1401  1.6941  5.1578 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   101.775      1.161  87.626  < 2e-16 ***
## seasonspring    1.355      1.643   0.825  0.42155    
## seasonsummer   -1.816      1.643  -1.105  0.28533    
## seasonwinter    4.959      1.643   3.019  0.00815 ** 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.597 on 16 degrees of freedom
## Multiple R-squared:  0.5333,	Adjusted R-squared:  0.4458 
## F-statistic: 6.095 on 3 and 16 DF,  p-value: 0.005739
```
...
## season       3  123.3   41.11   6.095 0.00574 **
## Residuals   16  107.9    6.75                   
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)      106.734      1.161  91.896  < 2e-16 ***
## spring_v_winter   -3.604      1.643  -2.194 0.043318 *  
## summer_v_winter   -6.775      1.643  -4.125 0.000794 ***
## fall_v_winter     -4.959      1.643  -3.019 0.008145 ** 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.597 on 16 degrees of freedom
