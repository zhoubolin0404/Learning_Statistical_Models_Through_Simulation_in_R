...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -1.0298 -0.3801 -0.1387  0.5269  1.1389 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.5238     0.3621  -1.446    0.186
## group_d       0.9153     0.5121   1.787    0.112
## 
## Residual standard error: 0.8097 on 8 degrees of freedom
## Multiple R-squared:  0.2854,	Adjusted R-squared:  0.196 
## F-statistic: 3.195 on 1 and 8 DF,  p-value: 0.1117
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.3915     0.3621   1.081    0.311
## group_d      -0.9153     0.5121  -1.787    0.112
## 
## Residual standard error: 0.8097 on 8 degrees of freedom
## Multiple R-squared:  0.2854,	Adjusted R-squared:  0.196 
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.5238     0.3621  -1.446    0.186
## groupB        0.9153     0.5121   1.787    0.112
## 
## Residual standard error: 0.8097 on 8 degrees of freedom
## Multiple R-squared:  0.2854,	Adjusted R-squared:  0.196 
## F-statistic: 3.195 on 1 and 8 DF,  p-value: 0.1117
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.7332 -1.8449  0.4168  1.2559  4.5102 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  103.8435     1.3727  75.651   <2e-16 ***
## seasonspring  -1.5205     1.9412  -0.783    0.445    
## seasonsummer  -2.3905     1.9412  -1.231    0.236    
## seasonwinter   0.8094     1.9412   0.417    0.682    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.069 on 16 degrees of freedom
## Multiple R-squared:  0.1723,	Adjusted R-squared:  0.01713 
## F-statistic:  1.11 on 3 and 16 DF,  p-value: 0.374
```
...
## season       3  31.38  10.461    1.11  0.374
## Residuals   16 150.73   9.421
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)     104.6529     1.3727  76.241   <2e-16 ***
## spring_v_winter  -2.3299     1.9412  -1.200    0.248    
## summer_v_winter  -3.1999     1.9412  -1.648    0.119    
## fall_v_winter    -0.8094     1.9412  -0.417    0.682    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.069 on 16 degrees of freedom
