...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -1.6733 -0.4402  0.1668  0.4427  1.1338 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.3883     0.4231   0.918    0.386
## group_d      -1.0196     0.5984  -1.704    0.127
## 
## Residual standard error: 0.9461 on 8 degrees of freedom
## Multiple R-squared:  0.2663,	Adjusted R-squared:  0.1746 
## F-statistic: 2.903 on 1 and 8 DF,  p-value: 0.1268
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.6313     0.4231  -1.492    0.174
## group_d       1.0196     0.5984   1.704    0.127
## 
## Residual standard error: 0.9461 on 8 degrees of freedom
## Multiple R-squared:  0.2663,	Adjusted R-squared:  0.1746 
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.3883     0.4231   0.918    0.386
## groupB       -1.0196     0.5984  -1.704    0.127
## 
## Residual standard error: 0.9461 on 8 degrees of freedom
## Multiple R-squared:  0.2663,	Adjusted R-squared:  0.1746 
## F-statistic: 2.903 on 1 and 8 DF,  p-value: 0.1268
...
## 10 spring         107.                1               0             0
## 11 summer         109.                0               1             0
## 12 summer          99.0               0               1             0
## 13 summer         102.                0               1             0
## 14 summer          99.7               0               1             0
## 15 summer          95.7               0               1             0
## 16 fall           102.                0               0             1
## 17 fall            98.2               0               0             1
## 18 fall           107.                0               0             1
## 19 fall           107.                0               0             1
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.8752 -2.0141  0.0605  2.5361  8.0716 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  104.0625     1.6461  63.218   <2e-16 ***
## seasonspring  -0.8333     2.3279  -0.358    0.725    
## seasonsummer  -2.9254     2.3279  -1.257    0.227    
## seasonwinter   0.1320     2.3279   0.057    0.955    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.681 on 16 degrees of freedom
## Multiple R-squared:  0.1212,	Adjusted R-squared:  -0.04352 
## F-statistic: 0.7359 on 3 and 16 DF,  p-value: 0.5458
```
...
## season       3  29.91   9.969   0.736  0.546
## Residuals   16 216.77  13.548
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)     104.1945     1.6461  63.298   <2e-16 ***
## spring_v_winter  -0.9653     2.3279  -0.415    0.684    
## summer_v_winter  -3.0574     2.3279  -1.313    0.208    
## fall_v_winter    -0.1320     2.3279  -0.057    0.955    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.681 on 16 degrees of freedom
