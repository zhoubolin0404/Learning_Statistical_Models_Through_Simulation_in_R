...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -1.24233 -0.51295 -0.07767  0.40326  1.43527 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.1350     0.3940   0.343    0.741
## group_d      -0.3557     0.5572  -0.638    0.541
## 
## Residual standard error: 0.8811 on 8 degrees of freedom
## Multiple R-squared:  0.04846,	Adjusted R-squared:  -0.07048 
## F-statistic: 0.4074 on 1 and 8 DF,  p-value: 0.5411
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.2207     0.3940  -0.560    0.591
## group_d       0.3557     0.5572   0.638    0.541
## 
## Residual standard error: 0.8811 on 8 degrees of freedom
## Multiple R-squared:  0.04846,	Adjusted R-squared:  -0.07048 
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.1350     0.3940   0.343    0.741
## groupB       -0.3557     0.5572  -0.638    0.541
## 
## Residual standard error: 0.8811 on 8 degrees of freedom
## Multiple R-squared:  0.04846,	Adjusted R-squared:  -0.07048 
## F-statistic: 0.4074 on 1 and 8 DF,  p-value: 0.5411
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.6430 -2.0950  0.0438  2.4685  5.4398 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   100.828      1.448  69.612   <2e-16 ***
## seasonspring    3.227      2.048   1.575   0.1347    
## seasonsummer    2.887      2.048   1.409   0.1779    
## seasonwinter    5.501      2.048   2.686   0.0162 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.239 on 16 degrees of freedom
## Multiple R-squared:  0.3129,	Adjusted R-squared:  0.184 
## F-statistic: 2.428 on 3 and 16 DF,  p-value: 0.1031
```
...
## season       3  76.42   25.47   2.428  0.103
## Residuals   16 167.83   10.49
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)      106.329      1.448  73.410   <2e-16 ***
## spring_v_winter   -2.274      2.048  -1.110   0.2833    
## summer_v_winter   -2.615      2.048  -1.276   0.2200    
## fall_v_winter     -5.501      2.048  -2.686   0.0162 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.239 on 16 degrees of freedom
