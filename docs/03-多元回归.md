...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -1.8099 -1.2445 -0.1159  1.2913  1.8515 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.2329     0.6561  -0.355    0.732
## group_d      -0.0227     0.9278  -0.024    0.981
## 
## Residual standard error: 1.467 on 8 degrees of freedom
## Multiple R-squared:  7.484e-05,	Adjusted R-squared:  -0.1249 
## F-statistic: 0.0005988 on 1 and 8 DF,  p-value: 0.9811
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.2556     0.6561  -0.390    0.707
## group_d       0.0227     0.9278   0.024    0.981
## 
## Residual standard error: 1.467 on 8 degrees of freedom
## Multiple R-squared:  7.484e-05,	Adjusted R-squared:  -0.1249 
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.2329     0.6561  -0.355    0.732
## groupB       -0.0227     0.9278  -0.024    0.981
## 
## Residual standard error: 1.467 on 8 degrees of freedom
## Multiple R-squared:  7.484e-05,	Adjusted R-squared:  -0.1249 
## F-statistic: 0.0005988 on 1 and 8 DF,  p-value: 0.9811
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.1612 -0.7349 -0.1050  1.3113  3.7934 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   102.488      1.033  99.222  < 2e-16 ***
## seasonspring    2.029      1.461   1.389  0.18383    
## seasonsummer   -1.358      1.461  -0.930  0.36624    
## seasonwinter    5.768      1.461   3.948  0.00115 ** 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.31 on 16 degrees of freedom
## Multiple R-squared:  0.6284,	Adjusted R-squared:  0.5587 
## F-statistic: 9.018 on 3 and 16 DF,  p-value: 0.0009934
```
...
## season       3 144.33   48.11   9.018 0.000993 ***
## Residuals   16  85.35    5.33                     
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)      108.256      1.033 104.806  < 2e-16 ***
## spring_v_winter   -3.738      1.461  -2.559 0.021007 *  
## summer_v_winter   -7.126      1.461  -4.878 0.000167 ***
## fall_v_winter     -5.768      1.461  -3.948 0.001150 ** 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.31 on 16 degrees of freedom
