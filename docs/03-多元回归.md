...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -1.03622 -0.40744 -0.05455  0.49233  1.33380 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.2347     0.3472  -0.676    0.518
## group_d       0.5859     0.4910   1.193    0.267
## 
## Residual standard error: 0.7764 on 8 degrees of freedom
## Multiple R-squared:  0.1511,	Adjusted R-squared:  0.04497 
## F-statistic: 1.424 on 1 and 8 DF,  p-value: 0.267
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.3512     0.3472   1.011    0.341
## group_d      -0.5859     0.4910  -1.193    0.267
## 
## Residual standard error: 0.7764 on 8 degrees of freedom
## Multiple R-squared:  0.1511,	Adjusted R-squared:  0.04497 
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.2347     0.3472  -0.676    0.518
## groupB        0.5859     0.4910   1.193    0.267
## 
## Residual standard error: 0.7764 on 8 degrees of freedom
## Multiple R-squared:  0.1511,	Adjusted R-squared:  0.04497 
## F-statistic: 1.424 on 1 and 8 DF,  p-value: 0.267
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -3.5833 -1.8213  0.0676  1.8101  4.1492 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  100.5145     1.0982  91.527   <2e-16 ***
## seasonspring   1.1432     1.5531   0.736   0.4723    
## seasonsummer   0.6231     1.5531   0.401   0.6936    
## seasonwinter   4.4059     1.5531   2.837   0.0119 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.456 on 16 degrees of freedom
## Multiple R-squared:  0.3751,	Adjusted R-squared:  0.2579 
## F-statistic: 3.201 on 3 and 16 DF,  p-value: 0.05164
```
...
## 多元回归和单因素方差分(one-way ANOVA)析的等价性
...
## season       3  57.91   19.30   3.201 0.0516 .
## Residuals   16  96.48    6.03                 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)      104.920      1.098  95.538   <2e-16 ***
## spring_v_winter   -3.263      1.553  -2.101   0.0519 .  
## summer_v_winter   -3.783      1.553  -2.436   0.0269 *  
## fall_v_winter     -4.406      1.553  -2.837   0.0119 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.456 on 16 degrees of freedom
