...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -2.0175 -0.7990  0.3389  0.6707  1.4656 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  0.09778    0.50042   0.195    0.850
## group_d      0.17515    0.70769   0.247    0.811
## 
## Residual standard error: 1.119 on 8 degrees of freedom
## Multiple R-squared:  0.007598,	Adjusted R-squared:  -0.1165 
## F-statistic: 0.06125 on 1 and 8 DF,  p-value: 0.8108
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.2729     0.5004   0.545    0.600
## group_d      -0.1751     0.7077  -0.247    0.811
## 
## Residual standard error: 1.119 on 8 degrees of freedom
## Multiple R-squared:  0.007598,	Adjusted R-squared:  -0.1165 
## F-statistic: 0.06125 on 1 and 8 DF,  p-value: 0.8108
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  0.09778    0.50042   0.195    0.850
## groupB       0.17515    0.70769   0.247    0.811
## 
## Residual standard error: 1.119 on 8 degrees of freedom
## Multiple R-squared:  0.007598,	Adjusted R-squared:  -0.1165 
## F-statistic: 0.06125 on 1 and 8 DF,  p-value: 0.8108
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -7.4991 -2.3921  0.9109  2.5424  3.0107 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   104.052      1.490  69.842   <2e-16 ***
## seasonspring   -1.145      2.107  -0.543   0.5944    
## seasonsummer   -4.338      2.107  -2.059   0.0562 .  
## seasonwinter    1.794      2.107   0.851   0.4071    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.331 on 16 degrees of freedom
## Multiple R-squared:  0.3596,	Adjusted R-squared:  0.2396 
## F-statistic: 2.995 on 3 and 16 DF,  p-value: 0.06181
```
...
## season       3  99.72   33.24   2.995 0.0618 .
## Residuals   16 177.56   11.10                 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)      105.846      1.490  71.047   <2e-16 ***
## spring_v_winter   -2.939      2.107  -1.395   0.1821    
## summer_v_winter   -6.132      2.107  -2.910   0.0102 *  
## fall_v_winter     -1.794      2.107  -0.851   0.4071    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.331 on 16 degrees of freedom
