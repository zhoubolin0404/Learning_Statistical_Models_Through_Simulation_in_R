...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -1.3849 -0.9057 -0.1990  0.5228  1.9346 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.1881     0.5245  -0.359    0.729
## group_d      -0.5219     0.7418  -0.704    0.502
## 
## Residual standard error: 1.173 on 8 degrees of freedom
## Multiple R-squared:  0.05828,	Adjusted R-squared:  -0.05944 
## F-statistic: 0.4951 on 1 and 8 DF,  p-value: 0.5016
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.7100     0.5245  -1.354    0.213
## group_d       0.5219     0.7418   0.704    0.502
## 
## Residual standard error: 1.173 on 8 degrees of freedom
## Multiple R-squared:  0.05828,	Adjusted R-squared:  -0.05944 
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.1881     0.5245  -0.359    0.729
## groupB       -0.5219     0.7418  -0.704    0.502
## 
## Residual standard error: 1.173 on 8 degrees of freedom
## Multiple R-squared:  0.05828,	Adjusted R-squared:  -0.05944 
## F-statistic: 0.4951 on 1 and 8 DF,  p-value: 0.5016
...
##  8 spring          99.1               1               0             0
##  9 spring          99.5               1               0             0
## 10 spring          97.6               1               0             0
## 11 summer          95.7               0               1             0
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.8967 -1.8568 -0.5412  1.3692  5.6450 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  100.9083     1.4669  68.790   <2e-16 ***
## seasonspring  -0.1414     2.0745  -0.068   0.9465    
## seasonsummer  -0.2846     2.0745  -0.137   0.8926    
## seasonwinter   5.2557     2.0745   2.533   0.0221 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.28 on 16 degrees of freedom
## Multiple R-squared:  0.3887,	Adjusted R-squared:  0.2741 
## F-statistic: 3.391 on 3 and 16 DF,  p-value: 0.0439
```
...
## season       3  109.5   36.49   3.391 0.0439 *
## Residuals   16  172.2   10.76                 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)      106.164      1.467  72.372   <2e-16 ***
## spring_v_winter   -5.397      2.075  -2.602   0.0193 *  
## summer_v_winter   -5.540      2.075  -2.671   0.0167 *  
## fall_v_winter     -5.256      2.075  -2.533   0.0221 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.28 on 16 degrees of freedom
