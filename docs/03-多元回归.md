...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -1.2723 -0.5067 -0.1178  0.5843  1.3071 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.4126     0.4075  -1.013    0.341
## group_d      -0.2131     0.5762  -0.370    0.721
## 
## Residual standard error: 0.9111 on 8 degrees of freedom
## Multiple R-squared:  0.01681,	Adjusted R-squared:  -0.1061 
## F-statistic: 0.1368 on 1 and 8 DF,  p-value: 0.7211
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.6257     0.4075  -1.536    0.163
## group_d       0.2131     0.5762   0.370    0.721
## 
## Residual standard error: 0.9111 on 8 degrees of freedom
## Multiple R-squared:  0.01681,	Adjusted R-squared:  -0.1061 
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.4126     0.4075  -1.013    0.341
## groupB       -0.2131     0.5762  -0.370    0.721
## 
## Residual standard error: 0.9111 on 8 degrees of freedom
## Multiple R-squared:  0.01681,	Adjusted R-squared:  -0.1061 
## F-statistic: 0.1368 on 1 and 8 DF,  p-value: 0.7211
...
##  8 spring          99.0               1               0             0
##  9 spring         104.                1               0             0
## 10 spring          99.8               1               0             0
## 11 summer          99.0               0               1             0
## 12 summer          96.9               0               1             0
## 13 summer          96.8               0               1             0
## 14 summer          98.2               0               1             0
## 15 summer         101.                0               1             0
## 16 fall           103.                0               0             1
## 17 fall           107.                0               0             1
## 18 fall           101.                0               0             1
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.1122 -1.4478 -0.1863  1.3990  4.6842 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   101.872      1.202  84.720   <2e-16 ***
## seasonspring   -1.688      1.701  -0.993   0.3356    
## seasonsummer   -3.487      1.701  -2.050   0.0571 .  
## seasonwinter    4.757      1.701   2.797   0.0129 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.689 on 16 degrees of freedom
## Multiple R-squared:  0.619,	Adjusted R-squared:  0.5476 
## F-statistic: 8.666 on 3 and 16 DF,  p-value: 0.001204
```
...
## season       3  188.0   62.65   8.666 0.0012 **
## Residuals   16  115.7    7.23                  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)      106.629      1.202  88.676  < 2e-16 ***
## spring_v_winter   -6.445      1.701  -3.790 0.001606 ** 
## summer_v_winter   -8.244      1.701  -4.848 0.000178 ***
## fall_v_winter     -4.757      1.701  -2.797 0.012912 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.689 on 16 degrees of freedom
