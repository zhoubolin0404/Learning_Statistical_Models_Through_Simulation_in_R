...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -1.1820 -0.5558 -0.0400  0.5859  1.5239 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.6135     0.3964  -1.548    0.160
## group_d      -0.1668     0.5606  -0.297    0.774
## 
## Residual standard error: 0.8864 on 8 degrees of freedom
## Multiple R-squared:  0.01094,	Adjusted R-squared:  -0.1127 
## F-statistic: 0.08849 on 1 and 8 DF,  p-value: 0.7737
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)  
## (Intercept)  -0.7803     0.3964  -1.968   0.0846 .
## group_d       0.1668     0.5606   0.297   0.7737  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.8864 on 8 degrees of freedom
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.6135     0.3964  -1.548    0.160
## groupB       -0.1668     0.5606  -0.297    0.774
## 
## Residual standard error: 0.8864 on 8 degrees of freedom
## Multiple R-squared:  0.01094,	Adjusted R-squared:  -0.1127 
## F-statistic: 0.08849 on 1 and 8 DF,  p-value: 0.7737
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.4299 -3.1001  0.0118  1.9689  6.2347 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  102.0037     1.5490  65.849   <2e-16 ***
## seasonspring   0.5900     2.1907   0.269   0.7911    
## seasonsummer  -0.8583     2.1907  -0.392   0.7004    
## seasonwinter   6.3843     2.1907   2.914   0.0101 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.464 on 16 degrees of freedom
## Multiple R-squared:  0.4584,	Adjusted R-squared:  0.3568 
## F-statistic: 4.514 on 3 and 16 DF,  p-value: 0.01778
```
...
## season       3  162.5   54.15   4.514 0.0178 *
## Residuals   16  192.0   12.00                 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)      108.388      1.549  69.971  < 2e-16 ***
## spring_v_winter   -5.794      2.191  -2.645  0.01765 *  
## summer_v_winter   -7.243      2.191  -3.306  0.00446 ** 
## fall_v_winter     -6.384      2.191  -2.914  0.01014 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.464 on 16 degrees of freedom
