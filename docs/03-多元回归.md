...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -0.9699 -0.4820 -0.1702  0.5760  1.3266 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.2612     0.3523  -0.741     0.48
## group_d       0.8398     0.4982   1.686     0.13
## 
## Residual standard error: 0.7877 on 8 degrees of freedom
## Multiple R-squared:  0.2621,	Adjusted R-squared:  0.1699 
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.5787     0.3523   1.643    0.139
## group_d      -0.8398     0.4982  -1.686    0.130
## 
## Residual standard error: 0.7877 on 8 degrees of freedom
## Multiple R-squared:  0.2621,	Adjusted R-squared:  0.1699 
## F-statistic: 2.842 on 1 and 8 DF,  p-value: 0.1303
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.2612     0.3523  -0.741     0.48
## groupB        0.8398     0.4982   1.686     0.13
## 
## Residual standard error: 0.7877 on 8 degrees of freedom
## Multiple R-squared:  0.2621,	Adjusted R-squared:  0.1699 
## F-statistic: 2.842 on 1 and 8 DF,  p-value: 0.1303
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.9311 -1.5139  0.3481  1.9756  4.7583 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  101.8801     1.4764  69.007   <2e-16 ***
## seasonspring  -0.6994     2.0879  -0.335   0.7420    
## seasonsummer  -1.1470     2.0879  -0.549   0.5904    
## seasonwinter   3.8951     2.0879   1.866   0.0805 .  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.301 on 16 degrees of freedom
## Multiple R-squared:  0.3135,	Adjusted R-squared:  0.1848 
## F-statistic: 2.436 on 3 and 16 DF,  p-value: 0.1024
```
...
## season       3  79.64   26.55   2.436  0.102
## Residuals   16 174.38   10.90
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)      105.775      1.476  71.645   <2e-16 ***
## spring_v_winter   -4.595      2.088  -2.201   0.0428 *  
## summer_v_winter   -5.042      2.088  -2.415   0.0281 *  
## fall_v_winter     -3.895      2.088  -1.866   0.0805 .  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.301 on 16 degrees of freedom
