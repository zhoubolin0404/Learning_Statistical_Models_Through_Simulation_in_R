...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -1.5163 -0.4092  0.1629  0.5373  1.1791 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.4788     0.4298   1.114    0.298
## group_d      -0.8802     0.6078  -1.448    0.186
## 
## Residual standard error: 0.961 on 8 degrees of freedom
## Multiple R-squared:  0.2077,	Adjusted R-squared:  0.1086 
## F-statistic: 2.097 on 1 and 8 DF,  p-value: 0.1856
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.4013     0.4298  -0.934    0.378
## group_d       0.8802     0.6078   1.448    0.186
## 
## Residual standard error: 0.961 on 8 degrees of freedom
## Multiple R-squared:  0.2077,	Adjusted R-squared:  0.1086 
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.4788     0.4298   1.114    0.298
## groupB       -0.8802     0.6078  -1.448    0.186
## 
## Residual standard error: 0.961 on 8 degrees of freedom
## Multiple R-squared:  0.2077,	Adjusted R-squared:  0.1086 
## F-statistic: 2.097 on 1 and 8 DF,  p-value: 0.1856
...
##  9 spring         104.                1               0             0
## 10 spring         102.                1               0             0
## 11 summer          98.3               0               1             0
## 12 summer         102.                0               1             0
## 13 summer          98.3               0               1             0
## 14 summer          97.4               0               1             0
## 15 summer         105.                0               1             0
## 16 fall            99.5               0               0             1
## 17 fall            97.3               0               0             1
## 18 fall           104.                0               0             1
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.3840 -1.9256  0.0635  1.8245  6.4849 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   101.461      1.460  69.499   <2e-16 ***
## seasonspring    2.799      2.065   1.356    0.194    
## seasonsummer   -1.259      2.065  -0.610    0.550    
## seasonwinter    2.725      2.065   1.320    0.205    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.264 on 16 degrees of freedom
## Multiple R-squared:  0.2651,	Adjusted R-squared:  0.1273 
## F-statistic: 1.924 on 3 and 16 DF,  p-value: 0.1664
```
...
## season       3   61.5   20.50   1.924  0.166
## Residuals   16  170.5   10.66
```
...
## Coefficients:
##                  Estimate Std. Error t value Pr(>|t|)    
## (Intercept)     104.18625    1.45988  71.366   <2e-16 ***
## spring_v_winter   0.07412    2.06458   0.036   0.9718    
## summer_v_winter  -3.98446    2.06458  -1.930   0.0715 .  
## fall_v_winter    -2.72527    2.06458  -1.320   0.2054    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.264 on 16 degrees of freedom
