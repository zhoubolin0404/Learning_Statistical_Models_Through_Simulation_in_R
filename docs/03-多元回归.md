...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -1.4249 -0.5314 -0.0744  0.6023  1.8069 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.2399     0.4658   0.515    0.620
## group_d       0.2582     0.6587   0.392    0.705
## 
## Residual standard error: 1.041 on 8 degrees of freedom
## Multiple R-squared:  0.01885,	Adjusted R-squared:  -0.1038 
## F-statistic: 0.1537 on 1 and 8 DF,  p-value: 0.7053
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.4981     0.4658   1.069    0.316
## group_d      -0.2582     0.6587  -0.392    0.705
## 
## Residual standard error: 1.041 on 8 degrees of freedom
## Multiple R-squared:  0.01885,	Adjusted R-squared:  -0.1038 
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.2399     0.4658   0.515    0.620
## groupB        0.2582     0.6587   0.392    0.705
## 
## Residual standard error: 1.041 on 8 degrees of freedom
## Multiple R-squared:  0.01885,	Adjusted R-squared:  -0.1038 
## F-statistic: 0.1537 on 1 and 8 DF,  p-value: 0.7053
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -7.2260 -2.3445  0.1278  1.9842  6.2264 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  103.5422     1.7068  60.663   <2e-16 ***
## seasonspring  -2.2845     2.4138  -0.946    0.358    
## seasonsummer  -0.6601     2.4138  -0.273    0.788    
## seasonwinter   1.5489     2.4138   0.642    0.530    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.817 on 16 degrees of freedom
## Multiple R-squared:  0.1397,	Adjusted R-squared:  -0.02165 
## F-statistic: 0.8658 on 3 and 16 DF,  p-value: 0.479
```
...
## season       3  37.83   12.61   0.866  0.479
## Residuals   16 233.07   14.57
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)      105.091      1.707  61.570   <2e-16 ***
## spring_v_winter   -3.833      2.414  -1.588    0.132    
## summer_v_winter   -2.209      2.414  -0.915    0.374    
## fall_v_winter     -1.549      2.414  -0.642    0.530    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.817 on 16 degrees of freedom
