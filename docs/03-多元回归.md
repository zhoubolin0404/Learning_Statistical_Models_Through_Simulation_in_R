...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -1.4716 -0.5030 -0.2301  0.7811  1.3337 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.2655     0.4472   0.594    0.569
## group_d      -0.7944     0.6325  -1.256    0.245
## 
## Residual standard error: 1 on 8 degrees of freedom
## Multiple R-squared:  0.1647,	Adjusted R-squared:  0.06032 
## F-statistic: 1.578 on 1 and 8 DF,  p-value: 0.2445
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -0.5290     0.4472  -1.183    0.271
## group_d       0.7944     0.6325   1.256    0.245
## 
## Residual standard error: 1 on 8 degrees of freedom
## Multiple R-squared:  0.1647,	Adjusted R-squared:  0.06032 
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   0.2655     0.4472   0.594    0.569
## groupB       -0.7944     0.6325  -1.256    0.245
## 
## Residual standard error: 1 on 8 degrees of freedom
## Multiple R-squared:  0.1647,	Adjusted R-squared:  0.06032 
## F-statistic: 1.578 on 1 and 8 DF,  p-value: 0.2445
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -3.3838 -1.8591 -0.1413  1.8610  3.7317 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   100.804      1.155  87.267  < 2e-16 ***
## seasonspring    2.200      1.634   1.347  0.19675    
## seasonsummer    2.517      1.634   1.541  0.14290    
## seasonwinter    4.957      1.634   3.035  0.00789 ** 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.583 on 16 degrees of freedom
## Multiple R-squared:  0.3665,	Adjusted R-squared:  0.2477 
## F-statistic: 3.086 on 3 and 16 DF,  p-value: 0.05709
```
...
## season       3  61.76  20.587   3.086 0.0571 .
## Residuals   16 106.74   6.671                 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)      105.761      1.155  91.559  < 2e-16 ***
## spring_v_winter   -2.757      1.634  -1.688  0.11088    
## summer_v_winter   -2.440      1.634  -1.494  0.15469    
## fall_v_winter     -4.957      1.634  -3.035  0.00789 ** 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.583 on 16 degrees of freedom
