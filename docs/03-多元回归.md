...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -2.02345 -0.90484  0.01738  0.69580  2.35870 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  0.06822    0.64230   0.106    0.918
## group_d     -1.14847    0.90835  -1.264    0.242
## 
## Residual standard error: 1.436 on 8 degrees of freedom
## Multiple R-squared:  0.1665,	Adjusted R-squared:  0.06236 
## F-statistic: 1.599 on 1 and 8 DF,  p-value: 0.2417
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -1.0802     0.6423  -1.682    0.131
## group_d       1.1485     0.9083   1.264    0.242
## 
## Residual standard error: 1.436 on 8 degrees of freedom
## Multiple R-squared:  0.1665,	Adjusted R-squared:  0.06236 
## F-statistic: 1.599 on 1 and 8 DF,  p-value: 0.2417
...
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  0.06822    0.64230   0.106    0.918
## groupB      -1.14847    0.90835  -1.264    0.242
## 
## Residual standard error: 1.436 on 8 degrees of freedom
## Multiple R-squared:  0.1665,	Adjusted R-squared:  0.06236 
## F-statistic: 1.599 on 1 and 8 DF,  p-value: 0.2417
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -3.8456 -1.8397 -0.1874  1.4219  5.7427 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   103.297      1.145  90.181   <2e-16 ***
## seasonspring   -1.809      1.620  -1.117    0.281    
## seasonsummer   -1.551      1.620  -0.957    0.353    
## seasonwinter    1.772      1.620   1.094    0.290    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.561 on 16 degrees of freedom
## Multiple R-squared:  0.2805,	Adjusted R-squared:  0.1456 
## F-statistic: 2.079 on 3 and 16 DF,  p-value: 0.1433
```
...
## season       3  40.92   13.64   2.079  0.143
## Residuals   16 104.96    6.56
```
...
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)    
## (Intercept)      105.068      1.145  91.728   <2e-16 ***
## spring_v_winter   -3.580      1.620  -2.210    0.042 *  
## summer_v_winter   -3.322      1.620  -2.051    0.057 .  
## fall_v_winter     -1.772      1.620  -1.094    0.290    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.561 on 16 degrees of freedom
